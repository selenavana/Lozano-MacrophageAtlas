...
#plot of cell counts by identities - thank you to Sanger Institute Cellular Genetics Informatics team for the base code for this figure https://github.com/cellgeni/notebooks/tree/309fa36e58db8a3182a86ef6e344862795684c3d/data
...
pdf("20230412 labeled aggr plots sctransform filtered - new.pdf", width = 8.5, height = 6)
plot_integrated_clusters(macrophage.integrated)
plot_integrated_clusters2(macrophage.integrated)
DimPlot(macrophage.integrated, reduction = "umap", label = TRUE, repel = TRUE)
DimPlot(macrophage.integrated, reduction = "tsne", label = TRUE, repel = TRUE)
...
saveRDS(macrophage.integrated, file = "20230412 macrophage integrated V5 - other cells removed.rds")