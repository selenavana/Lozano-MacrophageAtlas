...
#renaming clusters
{Heart <- RenameIdents(Heart, "0" = "0 - Resident Macrophage/Monocyte", "1" = "1 - Proliferating Cells", "2" = "2 - Dendritic Cells", "3" = "3 - Maturing Dendritic Cells", "4" = "4 - Ly6c-hi Inflitrating Macrophages", "5" = "5 - Niche Response Mac", 
...
#generating plots
pdf("20220617 labelled plots all organs.pdf", width = 8.5, height = 6)
DimPlot(Heart, reduction = "umap", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Heart")
DimPlot(Heart, reduction = "tsne", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Heart")
DimPlot(Brain, reduction = "umap", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Brain")
DimPlot(Brain, reduction = "tsne", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Brain")
DimPlot(Liver, reduction = "umap", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Liver")
DimPlot(Liver, reduction = "tsne", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Liver")
DimPlot(Lung, reduction = "umap", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Lung")
DimPlot(Lung, reduction = "tsne", label = TRUE, repel = TRUE, label.size = 3.5) + theme(legend.position = "none") + ggtitle("Lung")
dev.off()