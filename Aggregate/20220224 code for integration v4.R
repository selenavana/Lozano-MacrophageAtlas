...
#renaming clusters
{Heart <- RenameIdents(Heart, "0" = "Monocyte Derived", "4" = "Monocyte Derived", "6" = "Monocyte Derived", "7" = "Monocyte Derived", 
                      "1" = "Cycling", "9" = "Other", "10" = "Other", "11" = "Other", "14" = "Other", 
                      "2" = "Dendritic Cells", "3" = "Dendritic Cells", 
                      "5" = "Pro-inflammatory", "12" = "Pro-inflammatory", "8" = "Heart Tissue Resident", "13" = "Anti-inflammatory")
}
...
source("~/Desktop/scRNA.seq.course-master/course_files/utils/custom_seurat_functions.R")
plot_integrated_clusters(macrophage.integrated)

source("~/Desktop/scRNA.seq.course-master2/course_files/utils/custom_seurat_functions.R")
plot_integrated_clusters2(macrophage.integrated)

#plots into PDF, highlight each organ
pdf("20220226 labeled aggr plots sctransform filtered V2.pdf", width = 8.5, height = 6)
plot_integrated_clusters(macrophage.integrated)
plot_integrated_clusters2(macrophage.integrated)
DimPlot(macrophage.integrated, reduction = "umap", label = TRUE, repel = TRUE)
DimPlot(macrophage.integrated, reduction = "tsne", label = TRUE, repel = TRUE)
DimPlot(macrophage.integrated, reduction = "umap", label = FALSE, group.by = "cell.ident")
DimPlot(macrophage.integrated, reduction = "tsne", label = FALSE, group.by = "cell.ident")
...
saveRDS(macrophage.integrated, file = "20220226 macrophage integrated V4 - other cells removed.rds")
